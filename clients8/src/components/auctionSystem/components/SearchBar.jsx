...
export default function SearchBar() {
  return (
    <form className="flex overflow-hidden relative gap-5 px-5 py-3 border border-solid bg-white bg-opacity-10 border-zinc-300 border-opacity-10 rounded-[50px]">
      <img
        loading="lazy"
