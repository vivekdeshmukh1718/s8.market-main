    ...
    <div className="flex flex-col px-16 w-full max-md:px-5 max-md:max-w-full">
      <div className="flex relative flex-col items-start px-20 py-20 w-full min-h-[634px] rounded-[50px] max-md:px-5 max-md:max-w-full">
        ...
        <div className="relative mt-4 text-2xl leading-9 text-slate-600 max-md:max-w-full">
          Find your dream home through our residential property auctions.
          <br />
          From apartments to luxury villas, discover your perfect living space.
        </div>
            ...
            <div className="flex flex-col ml-5 w-[39%] max-md:ml-0 max-md:w-full">
              <div className="flex relative items-center gap-4 text-base leading-9 text-neutral-200 max-md:mt-10 group">
                ...
                <div className="flex-1 relative">
                  ...
                  >
                    <option value="" disabled selected className="bg-zinc-800 text-neutral-400">Select property type</option>
                    <option value="apartment" className="bg-zinc-800 text-neutral-200">Apartment</option>
                    <option value="house" className="bg-zinc-800 text-neutral-200">Independent House</option>
                    <option value="villa" className="bg-zinc-800 text-neutral-200">Villa</option>
                    <option value="penthouse" className="bg-zinc-800 text-neutral-200">Penthouse</option>
                  </select>
                </div>
              </div>
            </div>
