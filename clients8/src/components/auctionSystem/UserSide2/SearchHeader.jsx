...
//           Find prime commercial properties at competitive prices.
//           <br />
//           Office spaces, retail shops, and more.
//         </div>
...
//                     <option value="office" className="bg-zinc-800 text-neutral-200">Office Space</option>
//                     <option value="retail" className="bg-zinc-800 text-neutral-200">Retail Shop</option>
//                     <option value="warehouse" className="bg-zinc-800 text-neutral-200">Warehouse</option>
//                     <option value="hotel" className="bg-zinc-800 text-neutral-200">Hotel</option>
//                   </select>
//                 </div>
//               </div>
//             </div>
