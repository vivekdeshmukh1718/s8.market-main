...
//             <option value="office" className="bg-sky-900">Office Space</option>
//             <option value="retail" className="bg-sky-900">Retail Shop</option>
//             <option value="warehouse" className="bg-sky-900">Warehouse</option>
//             <option value="hotel" className="bg-sky-900">Hotel</option>
//           </select>
